-- ⚽ TCS HUB V2 - Delta (Reach Funcional)
...
-- Touch balls (Reach totalmente funcional no Delta)
    ...
    for _, ball in ipairs(balls) do
        for _, leg in ipairs(legParts) do
            ...
            if distance <= CONFIG.reach then
                ...
                break -- toca a bola só uma vez por perna
            end
        end
    end
end
...
print("🔵 TCS HUB V2 Delta loaded successfully! Reach funcional + Blue sphere + Hide/Show button active!")
