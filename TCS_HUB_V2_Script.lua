-- ⚽ TCS HUB V2 Delta - Reach Suave Funcional
...
local CONFIG = {
    reach = 10,
    magnetStrength = 50,       -- força do magnet suave
...
-- Touch balls (Reach suave via magnet)
...
print("🔵 TCS HUB V2 Delta carregado! Reach suave funcional ativo!")
