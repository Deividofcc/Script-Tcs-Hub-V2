-- ⚽ TCS HUB V2 Delta - Reach Original Corrigido e Confiável
...
-- Touch balls melhorado (mais confiável)
        ...
        if ti and ti.Parent then
            for _, ball in ipairs(balls) do
                ...
                if distance <= CONFIG.reach then
                    pcall(function()
                        -- chama firetouchinterest duas vezes pra confiabilidade
...
print("🔵 TCS HUB V2 Delta carregado! Reach confiável ativo!")
